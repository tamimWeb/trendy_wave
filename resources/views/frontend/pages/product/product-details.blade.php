                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-submit">
                                                        <button type="submit" id="submit"
                                                            class="w-auto axil-btn btn-bg-primary">Submit Comment</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
            ...
            <div class="recent-product-activation slick-layout-wrapper--15 axil-slick-arrow arrow-top-slide">
                <div class="slick-single-layout">
                    <div class="axil-product">
                        ...
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href="{{ route('product.details') }}">3D™ wireless headset</a></h5>
                ...
                <div class="slick-single-layout">
                    <div class="axil-product">
                        ...
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href="{{ route('product.details') }}">PS Remote Control</a></h5>
                                <div class="product-price-variant">
                ...
                <div class="slick-single-layout">
                    <div class="axil-product">
                        ...
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href="{{ route('product.details') }}">PS5 Remote Control</a></h5>
                                <div class="product-price-variant">
                                    <span class="price old-price">$50</span>
                                    <span class="price current-price">$38</span>
                                </div>
