            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-8 col-lg-6">
                    <div class="about-content content-right">
                        <span class="title-highlighter highlighter-primary2"> <i class="far fa-shopping-basket"></i>About
                            Store</span>
                        <h3 class="title">Online shopping includes both buying things online.</h3>
                        <span class="text-heading">Salesforce B2C Commerce can help you create unified, intelligent digital
                            commerce
                ...
                <div class="team-slide-activation slick-layout-wrapper--20 axil-slick-arrow  arrow-top-slide">
                    <div class="slick-single-layout">
                        <div class="axil-team-member">
                            <div class="thumbnail"><img src="{{ asset('frontend')}}/images/team/team-01.png" alt="Cody Fisher"></div>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-team-member">
                            <div class="thumbnail"><img src="{{ asset('frontend')}}/images/team/team-02.png" alt="Cody Fisher"></div>
                            <div class="team-content">
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-team-member">
                            <div class="thumbnail"><img src="{{ asset('frontend')}}/images/team/team-03.png" alt="Cody Fisher"></div>
                            <div class="team-content">
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-team-member">
                            <div class="thumbnail"><img src="{{ asset('frontend')}}/images/team/team-04.png" alt="Cody Fisher"></div>
                            <div class="team-content">
                                <span class="subtitle">Designer</span>
                                <h5 class="title">Alonso M. Miklonax</h5>
                            </div>
            ...
            <div class="row align-items-center mb--80 mb_sm--60">
                ...
                <div class="col-lg-7">
                    <div class="about-content content-right">
                        ...
                        <a href="{{ route('contact-us.index') }}" class="axil-btn btn-outline">Get In Touch</a>
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
