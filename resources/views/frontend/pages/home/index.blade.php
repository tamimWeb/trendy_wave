...
@section('content')
                        ...
                        <div class="slider-content-activation-one">
                            <div class="single-slide slick-slide" data-sal="slide-up" data-sal-delay="400"
                                ...
                                <div class="slide-action">
                                    <div class="shop-btn">
                                        <a href="{{ route('product.details') }}" class="axil-btn btn-bg-white"><i
                                                class="fal fa-shopping-cart"></i>Shop Now</a>
                                    </div>
                                    <div class="item-rating">
                                        <div class="thumb">
                                            <ul>
                                                <li><img src="{{ asset('frontend') }}/images/others/author1.png"
                                                        alt="Author">
                                                </li>
                                                <li><img src="{{ asset('frontend') }}/images/others/author2.png"
                                                        alt="Author">
                                                </li>
                                                <li><img src="{{ asset('frontend') }}/images/others/author3.png"
                                                        alt="Author">
                                                </li>
                                                <li><img src="{{ asset('frontend') }}/images/others/author4.png"
                                                        alt="Author">
                                                </li>
                                            </ul>
                                        </div>
            ...
            <div class="categrie-product-activation slick-layout-wrapper--15 axil-slick-arrow arrow-top-slide">
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend') }}/images/product/categories/elec-4.png"
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="300" data-sal-duration="500">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend') }}/images/product/categories/elec-5.png"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="400" data-sal-duration="500">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend') }}/images/product/categories/elec-11.png"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="500" data-sal-duration="500">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend') }}/images/product/categories/elec-6.png"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="600" data-sal-duration="500">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend') }}/images/product/categories/elec-2.png"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="700" data-sal-duration="500">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend') }}/images/product/categories/elec-7.png"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="800" data-sal-duration="500">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend') }}/images/product/categories/elec-8.png"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend') }}/images/product/categories/elec-1.png"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend') }}/images/product/categories/elec-9.png"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product">
                        <a href="#">
                            <img class="img-fluid" src="{{ asset('frontend') }}/images/product/categories/elec-10.png"
                                alt="product categorie">
        ...
        <div class="container">
                    ...
                    <div class="row row--15">
                            ...
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="{{ route('product.details') }}">
                                        <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="800"
                                            ...
                                            alt="Product Images">
                                        <img class="hover-img"
                                            src="{{ asset('frontend') }}/images/product/electric/product-08.png"
                                            alt="Product Images">
                                    </a>
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="{{ route('product.details') }}">Yantiti Leather &
                                                Canvas
                                                Bags</a></h5>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="{{ route('product.details') }}">
                                        <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="800"
                                            ...
                                            alt="Product Images">
                                        <img class="hover-img"
                                            src="{{ asset('frontend') }}/images/product/electric/product-06.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="quickview"><a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#quick-view-modal"><i class="far fa-eye"></i></a></li>
                                            <li class="select-option"><a href="{{ route('product.details') }}">Select
                                                    Option</a></li>
                                            <li class="wishlist"><a href="wishlist.html"><i class="far fa-heart"></i></a>
                                            </li>
                                        </ul>
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{ route('product.details') }}">Level 20 RGB
                                                Cherry</a>
                                        </h5>
                                        <div class="product-price-variant">
                                            <span class="price current-price">$29.99</span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{ route('product.details') }}">Logitech
                                                Streamcam</a>
                                        </h5>
                                        <div class="product-price-variant">
                                            <span class="price current-price">$29.99</span>
                            ...
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="{{ route('product.details') }}">
                                        <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800"
                                            loading="lazy"
                                            src="{{ asset('frontend') }}/images/product/electric/product-04.png"
                                            alt="Product Images">
                                        <img class="hover-img"
                                            src="{{ asset('frontend') }}/images/product/electric/product-05.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="{{ route('product.details') }}">3D™ wireless
                                                headset</a>
                                        </h5>
                                        <div class="product-price-variant">
                                            <span class="price current-price">$29.99</span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{ route('product.details') }}">Bass Meets
                                                Clarity</a>
                                        </h5>
                                        <div class="product-price-variant">
                                            <span class="price current-price">$29.99</span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{ route('product.details') }}">Mice Logitech</a>
                                        </h5>
                                        <div class="product-price-variant">
                                            <span class="price current-price">$29.99</span>
                                            <span class="price old-price">$49.99</span>
                            ...
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="{{ route('product.details') }}">
                                        <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="800"
                                            loading="lazy"
                                            src="{{ asset('frontend') }}/images/product/electric/product-07.png"
                                            alt="Product Images">
                                        <img class="hover-img"
                                            src="{{ asset('frontend') }}/images/product/electric/product-08.png"
                                            alt="Product Images">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        ...
                                        <h5 class="title"><a href="{{ route('product.details') }}">Zone Headphone</a>
                                        </h5>
                                        <div class="product-price-variant">
                                            <span class="price current-price">$29.99</span>
                                            <span class="price old-price">$49.99</span>
                    ...
                    <div class="row row--15">
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="{{ route('product.details') }}">
                                        <img src="{{ asset('frontend') }}/images/product/electric/product-01.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                                        <div class="product-badget">20% Off</div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="{{ route('product.details') }}">
                                        <img src="{{ asset('frontend') }}/images/product/electric/product-02.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="{{ route('product.details') }}">
                                        <img src="{{ asset('frontend') }}/images/product/electric/product-03.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                                        <div class="product-badget">20% Off</div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="{{ route('product.details') }}">
                                        <img src="{{ asset('frontend') }}/images/product/electric/product-04.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="{{ route('product.details') }}">
                                        <img src="{{ asset('frontend') }}/images/product/electric/product-05.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                                        <div class="product-badget">20% Off</div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="{{ route('product.details') }}">
                                        <img src="{{ asset('frontend') }}/images/product/electric/product-06.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                                        <div class="product-badget">20% Off</div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="{{ route('product.details') }}">
                                        <img src="{{ asset('frontend') }}/images/product/electric/product-07.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                                        <div class="product-badget">20% Off</div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="{{ route('product.details') }}">
                                        <img src="{{ asset('frontend') }}/images/product/electric/product-08.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                                        <div class="product-badget">20% Off</div>
            ...
            <div class="row">
                <div class="text-center col-lg-12 mt--20 mt_sm--0">
                    <a href="{{ route('shop.index') }}" class="axil-btn btn-bg-lighter btn-load-more">View All
                        Products</a>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="poster-countdown-thumbnail">
                            <img src="{{ asset('frontend') }}/images/product/poster/poster-03.png" alt="Poster Product">
                        ...
                        <div class="axil-product product-style-two">
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    ...
                                    <h5 class="title"><a href="{{ route('product.details') }}">Demon's Souls</a></h5>
                                    <div class="product-price-variant">
                                    ...
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="quickview"><a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#quick-view-modal"><i class="far fa-eye"></i></a></li>
                                            <li class="select-option"><a href="{{ route('product.details') }}">Add to
                                                    Cart</a></li>
                                            <li class="wishlist"><a href="wishlist.html"><i class="far fa-heart"></i></a>
                                            </li>
                                        </ul>
                        ...
                        <div class="axil-product product-style-two">
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    ...
                                    <h5 class="title"><a href="{{ route('product.details') }}">Google Home</a></h5>
                                    <div class="product-price-variant">
                        ...
                        <div class="axil-product product-style-two">
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    ...
                                    <h5 class="title"><a href="{{ route('product.details') }}">Netfilx Remot</a></h5>
                                    <div class="product-price-variant">
                        ...
                        <div class="axil-product product-style-two">
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    ...
                                    <h5 class="title"><a href="{{ route('product.details') }}">Digital
                                            Accessories</a>
                                    </h5>
                                    <div class="product-price-variant">
                        ...
                        <div class="axil-product product-style-two">
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    ...
                                    <h5 class="title"><a href="{{ route('product.details') }}">PS5 Smart Remote</a>
                                    </h5>
                                    <div class="product-price-variant">
                                        <span class="price old-price">$50</span>
                    ...
                    <div class="col">
                        <div class="axil-product-list">
                            <div class="thumbnail">
                                <a href="{{ route('product.details') }}">
                                    <img data-sal="zoom-in" data-sal-delay="100" data-sal-duration="1500"
                                        src="{{ asset('frontend') }}/images/product/electric/product-09.png"
                            ...
                            <div class="product-content">
                                ...
                                <h6 class="product-title"><a href="{{ route('product.details') }}">Media Remote</a>
                                </h6>
                                <div class="product-price-variant">
                                    <span class="price current-price">$29.99</span>
                                    <span class="price old-price">$49.99</span>
                            ...
                            <div class="thumbnail">
                                <a href="{{ route('product.details') }}">
                                    <img data-sal="zoom-in" data-sal-delay="200" data-sal-duration="1500"
                                        src="{{ asset('frontend') }}/images/product/electric/product-10.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                                ...
                                <h6 class="product-title"><a href="{{ route('product.details') }}">HD Camera</a></h6>
                                <div class="product-price-variant">
                            ...
                            <div class="thumbnail">
                                <a href="{{ route('product.details') }}">
                                    <img data-sal="zoom-in" data-sal-delay="300" data-sal-duration="1500"
                                        src="{{ asset('frontend') }}/images/product/electric/product-11.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                                ...
                                <h6 class="product-title"><a href="{{ route('product.details') }}">Gaming
                                        Controller</a>
                                </h6>
                                <div class="product-price-variant">
                            ...
                            <div class="thumbnail">
                                <a href="{{ route('product.details') }}">
                                    <img data-sal="zoom-in" data-sal-delay="400" data-sal-duration="1500"
                                        src="{{ asset('frontend') }}/images/product/electric/product-12.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                                ...
                                <h6 class="product-title"><a href="{{ route('product.details') }}">Wall Mount </a>
                                </h6>
                                <div class="product-price-variant">
                            ...
                            <div class="thumbnail">
                                <a href="{{ route('product.details') }}">
                                    <img data-sal="zoom-in" data-sal-delay="500" data-sal-duration="1500"
                                        src="{{ asset('frontend') }}/images/product/electric/product-13.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                                ...
                                <h6 class="product-title"><a href="{{ route('product.details') }}">Lenevo Laptop</a>
                                </h6>
                                <div class="product-price-variant">
                            ...
                            <div class="thumbnail">
                                <a href="{{ route('product.details') }}">
                                    <img data-sal="zoom-in" data-sal-delay="600" data-sal-duration="1500"
                                        src="{{ asset('frontend') }}/images/product/electric/product-14.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                                ...
                                <h6 class="product-title"><a href="{{ route('product.details') }}">Juice Grinder
                                        Machine</a></h6>
                                <div class="product-price-variant">
                    ...
                    <div class="col">
                        <div class="axil-product-list">
                            <div class="thumbnail">
                                <a href="{{ route('product.details') }}">
                                    <img data-sal="zoom-in" data-sal-delay="400" data-sal-duration="1500"
                                        src="{{ asset('frontend') }}/images/product/electric/product-15.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                                ...
                                <h6 class="product-title"><a href="{{ route('product.details') }}">Wireless
                                        Headphone</a>
                                </h6>
                                <div class="product-price-variant">
                    ...
                    <div class="col">
                        <div class="axil-product-list">
                            <div class="thumbnail">
                                <a href="{{ route('product.details') }}">
                                    <img data-sal="zoom-in" data-sal-delay="500" data-sal-duration="1500"
                                        src="{{ asset('frontend') }}/images/product/electric/product-16.png"
                                        alt="Yantiti Leather Bags">
                                </a>
                            </div>
                            <div class="product-content">
                                ...
                                <h6 class="product-title"><a href="{{ route('product.details') }}">Asus Zenbook
                                        Laptop</a>
                                </h6>
                                <div class="product-price-variant">
    ...
    <div class="mb-5 axil-testimoial-area axil-section-gap bg-vista-white">
        <div class="container">
            <div class="section-title-wrapper">
                <span class="title-highlighter highlighter-secondary"> <i
            ...
            <div
                ...
                <div class="slick-single-layout testimonial-style-one">
                    ...
                    <div class="media">
                        <div class="thumbnail">
                            <img src="{{ asset('frontend') }}/images/testimonial/image-1.png" alt="testimonial image">
                        </div>
                ...
                <div class="slick-single-layout testimonial-style-one">
                    ...
                    <div class="media">
                        <div class="thumbnail">
                            <img src="{{ asset('frontend') }}/images/testimonial/image-2.png" alt="testimonial image">
                        </div>
                        <div class="media-body">
                            <span class="designation">Head Of Idea</span>
                            <h6 class="title">James C. Anderson</h6>
                ...
                <div class="slick-single-layout testimonial-style-one">
                    ...
                    <div class="media">
                        <div class="thumbnail">
                            <img src="{{ asset('frontend') }}/images/testimonial/image-3.png" alt="testimonial image">
                        </div>
                        <div class="media-body">
                            <span class="designation">Head Of Idea</span>
                            <h6 class="title">James C. Anderson</h6>
