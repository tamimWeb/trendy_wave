                    ...
                    <div class="row row--15">
                        <div class="col-xl-4 col-sm-6">
                            <div class="axil-product product-style-one mb--30">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{ route('product.details') }}">3D™ wireless headset</a>
                                        </h5>
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="axil-product product-style-one mb--30">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{ route('product.details') }}">Media remote</a></h5>
                                        <div class="product-price-variant">
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="axil-product product-style-one mb--30">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{ route('product.details') }}">HD camera</a></h5>
                                        <div class="product-price-variant">
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="axil-product product-style-one mb--30">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{ route('product.details') }}">Guys Bomber Jacket</a></h5>
                                        <div class="product-price-variant">
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="axil-product product-style-one mb--30">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{ route('product.details') }}">Level 20 RGB Cherry</a></h5>
                                        <div class="product-price-variant">
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="axil-product product-style-one mb--30">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{ route('product.details') }}">Logitech Streamcam</a></h5>
                                        <div class="product-price-variant">
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="axil-product product-style-one mb--30">
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{ route('product.details') }}">Bass Meets Clarity</a></h5>
                                        <div class="product-price-variant">
