                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="product-thumbnail"><a href="single-product.html"><img
                                        src="{{ asset('frontend')}}/images/product/electric/product-01.png" alt="Digital Product"></a></td>
                        ...
                        <tr>
                            ...
                            <td class="product-thumbnail"><a href="single-product-2.html"><img
                                        src="{{ asset('frontend')}}/images/product/electric/product-02.png" alt="Digital Product"></a></td>
                        ...
                        <tr>
                            <td class="product-remove"><a href="#" class="remove-wishlist"><i
                                        class="fal fa-times"></i></a></td>
                            <td class="product-thumbnail"><a href="{{ route('product.details') }}"><img
                                        src="{{ asset('frontend')}}/images/product/electric/product-03.png" alt="Digital Product"></a></td>
