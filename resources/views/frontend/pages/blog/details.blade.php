                ...
                <div class="content-block">
                    <div class="inner">
                        <div class="post-thumbnail">
                            <img src="{{ asset('frontend') }}/images/blog/blog-single.jpg" alt="blog Images">
                        </div>
                        <!-- End .thumbnail -->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 axil-post-wrapper">
                        <div class="post-heading">
                            ...
                            <div class="axil-post-meta">
                                <div class="post-author-avatar">
                                    <img src="{{ asset('frontend') }}/images/blog/author-image-1.png" alt="Author Images">
                                </div>
                        ...
                        <p>Habitasse per feugiat aliquam luctus accumsan curae, suspendisse aliquam taciti eros neque,
                            aenean sit iaculis risus commodo ut sociosqu rhoncus potenti tristique placerat sit tempus, duis
                            erat feugiat cras sociosqu porta ut
                            praesent, fermentum donec convallis tellus vulputate duis nibh rhoncus phasellus dui massa nisl.
                        </p>

                        <p> Whether you’re kicking off a new campaign or looking to revamp your strategy, the lessons you’ll
                        ...
                        <p> MailChimp is an email marketing service provider founded in 2001. It has 9 million users that
                            collectively send over 15 billion emails through the service each month.</p>

                        <p> Email is a crucial channel in any marketing mix, and never has this been truer than for today’s
                            entrepreneur. Curious what to say? How to say it? How often to hit “send”? Each bite-sized
                            lesson delivers core concepts, guiding
                        ...
                        <div class="content-blog format-quote mt--10 mb--50 mb_sm--30">
                            <div class="inner">
                                <div class="content">
                                    <blockquote>
                                        <p>“Email is a crucial channel in any marketing mix, and never has this been truer
                                            than for today’s entrepreneur. Curious what to say? How to say it? How often to
                                            hit “send”? Each bite-sized lesson delivers core
                                            concepts, guiding questions, and tactical how-to resources.”</p>
                                    </blockquote>
                                    <div class="axil-post-meta">
                                        <div class="post-author-avatar">
                                            <img src="{{ asset('frontend') }}/images/blog/author-image-1.png"
                                                alt="Author Images">
                                        </div>
                                        <div class="post-meta-content">
                                            <h6 class="author-title">
                        ...
                        <div class="post-details wp-block-columns alignwide has-2-columns">
                            <div class="wp-block-column">
                                <figure class="wp-block-image is-resized">
                                    <img class="img-fluid" src="{{ asset('frontend') }}/images/blog/blog-01.png"
                                        alt="blog image">
                                </figure>
                            ...
                            <div class="wp-block-column">
                                <figure class="wp-block-image is-resized">
                                    <img class="img-fluid" src="{{ asset('frontend') }}/images/blog/blog-02.png"
                                        alt="blog image">
                                </figure>
                            </div>
                        </div>
                        ...
                        <p> December 03, 2020 - The Nike Air Zoom SuperRep 2 is designed for high-intensity interval
                            training (HIIT) in group classes or solo sessions. This second version comes with two updated
                            features for a better fit: a fully adjustable,
                            burrito-style tongue and a roomier forefoot.</p>

                        <p>The SuperRep 2 evolves an important facet of modern fitness — training as sport — and the idea
                            that it's deserving of footwear designed to support the performance needs specific to these
                            movements. That’s why the shoe keeps
                            ...
                            <ul class="comment-list">
                                    ...
                                    <div class="comment-body">
                                        <div class="single-comment">
                                            <div class="comment-img">
                                                <img src="{{ asset('frontend') }}/images/blog/author-image-4.png"
                                                    alt="Author Images">
                                            </div>
                                ...
                                <li class="comment">
                                    <div class="comment-body">
                                        <div class="single-comment">
                                            <div class="comment-img">
                                                <img src="{{ asset('frontend') }}/images/blog/author-image-5.png"
                                                    alt="Author Images">
                                            </div>
                                            <div class="comment-inner">
                                                <h6 class="commenter">
                    ...
                    <div class="content-blog">
                        <div class="inner">
                            <div class="axil-gallery-activation axil-slick-arrow arrow-between-side">
                                ...
                                <div class="thumbnail">
                                    <a href="{{ route('blog.details') }}">
                                        <img src="{{ asset('frontend') }}/images/blog/blog-07.png" alt="Blog Images">
                                    </a>
                                </div>
                                <!-- End Single Thumb  -->
                            </div>
                            <div class="content">
                                <h5 class="title"><a href="{{ route('blog.details') }}">With an Irreverent Twist, AMBUSH®
                    ...
                    <div class="content-blog">
                        <div class="inner">
                            <div class="axil-gallery-activation axil-slick-arrow arrow-between-side">
                                ...
                                <div class="thumbnail">
                                    <a href="{{ route('blog.details') }}">
                                        <img src="{{ asset('frontend') }}/images/blog/blog-08.png" alt="Blog Images">
                                    </a>
                                </div>
                                <!-- End Single Thumb  -->
                            </div>
                            <div class="content">
                                <h5 class="title"><a href="{{ route('blog.details') }}">UCLA Athletics Reaches Multi-Year
                                        Agreement with NIKE, Inc. and Jordan Brand</a></h5>
                                <div class="axil-post-meta">
                                    <div class="post-author-avatar">
                                        <img src="{{ asset('frontend') }}/images/blog/author-image-2.png"
                                            alt="Author Images">
                                    </div>
                                    <div class="post-meta-content">
                                        <h6 class="author-title">
                    ...
                    <div class="content-blog">
                        <div class="inner">
                            <div class="axil-gallery-activation axil-slick-arrow arrow-between-side">
                                ...
                                <div class="thumbnail">
                                    <a href="{{ route('blog.details') }}">
                                        <img src="{{ asset('frontend') }}/images/blog/blog-09.png" alt="Blog Images">
                                    </a>
                                </div>
                                <!-- End Single Thumb  -->
                            </div>
                            <div class="content">
                                <h5 class="title"><a href="{{ route('blog.details') }}">An oral history of the AIM away
                                        message by the people who were there</a></h5>
                                <div class="axil-post-meta">
                                    <div class="post-author-avatar">
                                        <img src="{{ asset('frontend') }}/images/blog/author-image-3.png"
                                            alt="Author Images">
                                    </div>
                                    <div class="post-meta-content">
                                        <h6 class="author-title">
